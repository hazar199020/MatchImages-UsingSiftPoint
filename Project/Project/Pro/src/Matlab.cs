...
{
  /// <summary>
  /// The Matlab class provides a CLS compliant, MWArray interface to the M-functions
  ...
  public class Matlab : IDisposable
  {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray match(MWArray des1)
    {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray match(MWArray des1, MWArray des2)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] match(int numArgsOut, MWArray des1)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] match(int numArgsOut, MWArray des1, MWArray des2)
    {
    ...
    /// <summary>
    /// Provides a single output, 0-input MWArrayinterface to the sift M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// Load image
    ...
    public MWArray sift()
    {
      return mcr.EvaluateFunction("sift", new MWArray[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input MWArrayinterface to the sift M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// Load image
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray sift(MWArray imageFile)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input MWArray interface to the sift M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// Load image
    ...
    /// arguments.</returns>
    ///
    public MWArray[] sift(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "sift", new MWArray[]{});
    }


    /// <summary>
    /// Provides the standard 1-input MWArray interface to the sift M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// Load image
    ...
    /// arguments.</returns>
    ///
    public MWArray[] sift(int numArgsOut, MWArray imageFile)
    {
    ...
    /// <summary>
    /// Provides an interface for the sift function in which the input and output
    /// arguments are specified as an array of MWArrays.
    /// </summary>
    /// <remarks>
    /// This method will allocate and return by reference the output argument
    ...
    /// <param name= "argsIn">Array of MWArray input arguments</param>
    ///
    public void sift(int numArgsOut, ref MWArray[] argsOut, MWArray[] argsIn)
    {
      mcr.EvaluateFunction("sift", numArgsOut, ref argsOut, argsIn);
    }
